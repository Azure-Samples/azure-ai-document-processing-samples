...
output aiModelsInfo object = {
  ...
  phiEndpoint: aiHubProject.outputs.serverlessModelDeployments[0].endpoint
  phiPrimaryKeySecretName: aiHubProject.outputs.serverlessModelDeployments[0].primaryKeySecretName
}
